...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2024 at 09:32 AM
...
(13, 'Computer Engineering', '5', '5', '1', '1', 'aeqdasda', '2024-05-22', '15:25', 'Started');
...
(22, 'aeqdasda', 'Computer Engineering', '121', '22', '3', '3', '4', '22');
...
(8, 10, 'qeqeq', 'alfragile@yahoo.com', 'aeqdasda', 'Ended');
...
--
ALTER TABLE `add_question`
  MODIFY `question_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `std_exam_status`
  MODIFY `status_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
